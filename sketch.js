...
function preload(){
    manI = loadImage("manInUmbrella.png");
    l1i = loadImage("slazzer-edit-image (2).png")
    l2i = loadImage("slazzer-edit-image__3_-removebg-preview.png")
    l3i = loadImage("white-lightning-illustration-png-clip-art-thumbnail (1).png")
}
...
function setup(){
   ...
   // manI.scale = 0.45
    ...
    for(var i =0 ; i< maxDrops ; i++){ 
        //rain = 
 drops.push(new Rain(random(0,400),random(0,650)))
